...
Contribution standards for repositories in the Avalon Initiative organization, with
emphasis on clarity and safety. A repository can override this file with its own
`CONTRIBUTING.md`.
...
just seems off, raise it first — an issue or an org Discussion — before working
...
Each repository documents its own install/build/test/lint commands in its
README or its own `CONTRIBUTING.md`.
